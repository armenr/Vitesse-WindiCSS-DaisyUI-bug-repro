          ...
          <div>
            <button
              ...
              class="
                ...
                text-gray-500
                hover:text-gray-900
                focus:outline-none focus:ring-2 focus:ring-inset focus:ring-pink-600
              "
            >
              ...
              <div class="mt-1 grid grid-cols-1 gap-4 sm:grid-cols-2">
                <div
                  class="
                    ...
                    focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-pink-500
                  "
                >
                ...
                <li>
                  <div
                    class="
                      ...
                      space-x-3
                      hover:bg-gray-50
                      focus-within:ring-2 focus-within:ring-inset focus-within:ring-pink-500
                    "
                  >
                    <div class="flex-shrink-0">
                      <img
